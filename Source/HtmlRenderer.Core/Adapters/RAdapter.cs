...
namespace TheArtOfDev.HtmlRenderer.Adapters
{
    ...
    public abstract class RAdapter
    {
        ...
        public RImage GetLoadingImage()
        {
            if (_loadImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("HtmlRenderer.Core.Core.Utils.ImageLoad.png");
                if (stream != null)
        ...
        public RImage GetLoadingFailedImage()
        {
            if (_errorImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("HtmlRenderer.Core.Core.Utils.ImageError.png");
                if (stream != null)
