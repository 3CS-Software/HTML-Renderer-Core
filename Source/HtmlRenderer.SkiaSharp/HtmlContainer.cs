...
namespace TheArtOfDev.HtmlRenderer.SkiaSharp
{
    ...
    public sealed class HtmlContainer : IDisposable
    {
        ...
        {
            _htmlContainerInt = new HtmlContainerInt(SkiaSharpAdapter.Instance);
        ...
        public void PerformLayout(SKCanvas g, SKBitmap b)
        {
            ArgChecker.AssertArgNotNull(g, "g");

            using (var ig = new GraphicsAdapter(g, b))
            {
        ...
        public void PerformPaint(SKCanvas g, SKBitmap b)
        {
            ArgChecker.AssertArgNotNull(g, "g");
